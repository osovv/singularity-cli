...
## Keywords
singularity, cli, task-manager, bun, citty, kubb, openapi, grace

## Annotation
Bun-based CLI client for the Singularity task manager API with local OpenAPI snapshots, generated SDK surfaces, and standalone binary builds.
